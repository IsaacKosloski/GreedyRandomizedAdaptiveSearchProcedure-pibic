...
int main(int argc,char **argv)
{
    ...
    double bestTourCost = tourCost(bestTour, tsp->nodesDistance, tsp->dimensionOfNodes);
    printResult(bestTour, argv[2], elapsed.count(), bestTourCost, tsp->dimensionOfNodes, MAX_ITERATION);
